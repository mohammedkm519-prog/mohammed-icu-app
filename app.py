...
def analyze_lab_image(image_file):
    ...
    try:
        ...
        هذه صورة لورقة تحاليل طبية. استخرج جميع الأرقام والنتائج الموجودة في الصورة.
        
        ركز بشكل خاص على استخراج هذه القيم:
                        ...
                        with st.spinner("جاري تحليل الصورة واستخراج البيانات..."):
                            ...
                            if result["success"]:
                                ...
                                if result["data"]:
                                    ...
                                    st.warning("لم يتم استخراج بيانات من الصورة. حاول مرة أخرى.")
