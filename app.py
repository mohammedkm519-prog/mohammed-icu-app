...
# ======================================================================
# 📸 تحليل الصور - النسخة المبسطة والمضمونة
# ======================================================================
...
def dashboard():
    ...
    if patient:
        ...
        with tabs[2]:
            ...
            st.markdown("قم برفع صورة لورقة التحاليل وسيقوم Gemini بقراءة الأرقام تلقائياً")
            ...
            if uploaded_lab:
                ...
                with col2:
                    st.info("🤖 سيتم استخدام Gemini AI لتحليل الصورة")
        ...
        with tabs[4]:
            ...
            if not has_permission(st.session_state.user, "ai_analysis"):
                ...
                st.info("🤖 يستخدم Gemini AI للتحليل")
