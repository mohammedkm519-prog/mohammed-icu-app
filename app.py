...
def analyze_lab_image(image_file):
    if not GEMINI_AVAILABLE:
        return {"success": False, "error": "Gemini API غير متاحة", "data": {}}
...
# ======================================================================
# 🔐 صفحة تسجيل الدخول مع اختيار اللغة
# ======================================================================
                        ...
                        with st.spinner("جاري تحليل الصورة واستخراج البيانات..."):
                            ...
                            if result["success"]:
                                ...
                                if result["data"]:
                                    ...
                                    st.warning("لم يتم استخراج بيانات من الصورة.")
